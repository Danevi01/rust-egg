...
# The script finishes here. The Pterodactyl Daemon will execute the STARTUP command next.
echo "Entrypoint script finished. Preparing to execute Pterodactyl startup command..."
